...
public class CPUplayer  implements PlayerInterface  {
	...
	private volatile int  whereWinning=-1;
...
class myThread extends Thread{
	int index;
	CPUplayer aCpUplayer;
	char Symbol;
	public myThread(int index, CPUplayer aCpUplayer,char Symbol) {
	this.index=index;
	this.aCpUplayer=aCpUplayer;
	this.Symbol=Symbol;
	}
	public void run()
	{
		aCpUplayer.whereWining(Symbol);
	}
}