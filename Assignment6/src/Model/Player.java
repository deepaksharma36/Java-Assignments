...
/**
 * This class lets the player play the connect four field game between two human players or
 * between a human player and the CPU.
 * Every player has a name and a symbol(game piece) assigned.
 * PlayerInterface methods implements this method.
 * 
