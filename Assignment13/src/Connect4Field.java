 ...
 */
public class Connect4Field implements Serializable, Connect4FieldInterface {
	public String error = "";
	...
	public void setSizeBoard(int sizeBoardX,int sizeBoardY) {
		this.sizeBoard[0] = sizeBoardX;
		this.sizeBoard[1] = sizeBoardY;
	}
